...
create index if not exists asset_attachments_asset_idx on public.asset_attachments(asset_type,asset_id,created_at desc);
...
do $$ declare t text; begin
  foreach t in array array['rooms','computers','hardware','licenses','stations','station_plugins','reminders','audit_log','app_settings','asset_attachments'] loop
...
-- Storage privato per gli allegati degli asset (10 MB per file).
...
-- Mantiene aggiornato il contatore già presente su Computer e Hardware.
